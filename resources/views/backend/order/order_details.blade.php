    ...
    <div class="tab-pane" id="settings">
        ...
        <div class="mb-3">
            <label for="firstname" class="form-label">Customer Name</label>
             <p class="text-danger"> {{ $order->customer_name }} </p>
        </div>
    </div>
   ...
   <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Payment Method </label>
             <p class="text-danger"> {{ $order->payment_method }} </p>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Paid Amount </label>
             <p class="text-danger"> {{ $order->payment_received }} </p>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Change </label>
             <p class="text-danger"> {{ $order->change_given }} </p>
        </div>
    </div>
